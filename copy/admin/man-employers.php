...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
  ...
  <div class="flex flex-col md:flex-row">
    ...
    <aside class="bg-blue-900 w-full md:w-64 min-h-screen shadow-md" id="sidebar">
      <div class="py-6">
        ...
        <ul class="mt-6">
          ...
          <li class="border-t border-b border-yellow-50 px-6 py-2.5 bg-blue-800"><a href="man-employers.php" class="flex items-center space-x-2 text-yellow-100 font-semibold hover:text-yellow-50 hover:no-underline"><i class="fa fa-building"></i> <span>Manage Employers</span></a></li>
    ...
    <main class="flex-1 p-6">
      <section class="mb-6">
        <h3 class="text-2xl font-bold text-indigo-900">Employers</h3>
        <div class="mt-4">
